...
namespace
{
	...
	QElapsedTimer s_tickTimer;

	bool InitGetTickCount()
	{
		s_tickTimer.start();
		return true;
	}

	bool s_tickTimerInited = InitGetTickCount();
	
	unsigned int GetTickCount()
	{
		return static_cast< unsigned int >( s_tickTimer.elapsed() );
	}
